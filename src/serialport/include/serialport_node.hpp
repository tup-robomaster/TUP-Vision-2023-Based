 ...
 * @LastEditTime: 2023-02-06 00:58:36
...
namespace serialport
{
    ...
    public:
        ...
        // bool float2UcharRawArray(float float_data[], int num, unsigned char* raw_data);
    ...
    public:
        // tf2
        // rclcpp::Subscription<SerialMsg>::SharedPtr imu_data_sub_;
        ...
        // void handle_imu_data(const std::shared_ptr<SerialMsg>& msg);
