...
function joinLogs(){
  $.ajax({
    type : "POST",
    url : "./daksys-webhelp/resources/php/joinLogs.php",
    data : "",
...
Log.prototype.openDebugWindow = function() {
  //  var url = "./debug.html";
  this.debugWindow = open( '', 'dksgenWHDebug', "left=50, width=700,height=400,titlebar=0, resizable=1, location=0,status=yes,toolbar=no,scrollbars=yes,menubar=no" );
  if( !this.debugWindow || this.debugWindow.closed || !this.debugWindow.writeDebug ) {
    this.debugWindow = window.open( '', 'dksgenWHDebug', "left=50,width=600,height=400,titlebar=0,resizable=1, location=0,status=yes,toolbar=no,scrollbars=yes,menubar=no" );
    this.debugWindow.document.write('<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n\
      <html>\n\
<head>\n\
<title>Debug window for dksgen Web Help</title>\n\
<script type="text/javascript" src="./daksys-webhelp/resources/js/jquery-3.1.1.min.js"> </script>\n\
<style type="text/css">\n\
#debug{\n\
width: 100%;\n\
height: 100%; \n\
...
<div id="debug">\n\
<u>dksgen XML Web Help debug window</u><br>\n\
</div>\n\
</body>\n\
</html>');
