 ...
 * @LastEditTime: 2023-04-26 14:07:58
...
namespace armor_processor
{
    ...
    public:
        ...
        bool predict(TargetInfo target, double bullet_speed, double dt, double& delay_time, Eigen::Vector3d& pred_point3d, vector<Eigen::Vector3d>& armor_point3d, cv::Mat* src = nullptr);
    ...
    private:
        ...
        // Uniform Model.
        bool predictBasedUniformModel(bool is_target_lost, Eigen::VectorXd meas, double dt, double pred_dt, double spinning_period, Eigen::Vector3d& result, vector<Eigen::Vector3d>& armor_point3d_vec);
