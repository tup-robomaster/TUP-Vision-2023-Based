 ...
 * @LastEditTime: 2022-09-06 18:04:04
 * @FilePath: /tup_2023/src/camera_driver/src/hik_camera.cpp
 */
#include "../include/hik_camera.h"

namespace camera_driver
{
    hik_camera::hik_camera(rclcpp::Node::SharedPtr node)
    {
        this->node = node;
    }
    ...
    int hik_camera::start_device(int serial_number)
    {   //打开设备
